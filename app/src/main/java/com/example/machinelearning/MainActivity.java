...
import com.example.machinelearning.ml.Rostros;
...
protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    public void PersonalizedModel(View v){
        try {
            ...
            Rostros model = Rostros.newInstance(getApplicationContext());
            TensorBuffer inputFeature0 = TensorBuffer.createFixedSize(new int[]{1, 224, 224, 3}, DataType.FLOAT32);
            inputFeature0.loadBuffer(convertirImagenATensorBuffer(mSelectedImage));
            Rostros.Outputs outputs = model.process(inputFeature0);
